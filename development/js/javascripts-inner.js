...
$(document).ready(function() {
            ...
            $("input[type='radio']").parents("dd").attr("data-toggle","my_buttons");
...
//            $("#exp_date-element input, #c_expire-element input").attr("value" , "Expire date");
            ...
            var itemsLength = $(".carousel .carousel-inner .item").length;
            var items = ("");
            
            for ( var i = 0; i < itemsLength; i++ ) {
              items += ("<li data-target='#carousel-example-generic' data-slide-to='" + i + "'></li>");
            }
            ...
            $(".media.list-group-item").parents(".panel-body").removeClass("panel-body");
             ...
             $("[data-toggle='buttons'] input[type='radio']").click(function() {
                $(this).closest("[data-toggle='buttons']").find("label.active").removeClass("active");
                $(this).closest("label").addClass("active");
            })
            $("input[type='radio']").closest("label").addClass("btn btn-primary");
